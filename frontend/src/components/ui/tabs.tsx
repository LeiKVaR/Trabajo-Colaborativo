...
const tabsListVariants = cva(
  "inline-flex w-fit items-center justify-center rounded-lg p-[3px] text-muted-foreground data-[orientation=vertical]:flex-col data-[variant=line]:rounded-none bg-muted",
  {
    variants: {
      variant: {
        default: "bg-muted",
